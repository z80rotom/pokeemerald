...
import pokedextextjson.pokedextext as pokedextext
...
POKEDEX_TEXT_JSON_FPATH = "pokedextextjson/pokedex_text.json"
POKEDEX_TEXT_H_FPATH = "../src/data/pokemon/pokedex_text.h"
...
def main():
    ...
    pokedextext.build_pokedex_text(POKEDEX_TEXT_JSON_FPATH,
                                   POKEDEX_TEXT_H_FPATH)
