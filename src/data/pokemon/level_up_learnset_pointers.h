const u16 *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_OLD_UNOWN_B] = sOldUnownBLevelUpLearnset,
    [SPECIES_OLD_UNOWN_C] = sOldUnownCLevelUpLearnset,
    [SPECIES_OLD_UNOWN_D] = sOldUnownDLevelUpLearnset,
    [SPECIES_OLD_UNOWN_E] = sOldUnownELevelUpLearnset,
    [SPECIES_OLD_UNOWN_F] = sOldUnownFLevelUpLearnset,
    [SPECIES_OLD_UNOWN_G] = sOldUnownGLevelUpLearnset,
    [SPECIES_OLD_UNOWN_H] = sOldUnownHLevelUpLearnset,
    [SPECIES_OLD_UNOWN_I] = sOldUnownILevelUpLearnset,
    [SPECIES_OLD_UNOWN_J] = sOldUnownJLevelUpLearnset,
    [SPECIES_OLD_UNOWN_K] = sOldUnownKLevelUpLearnset,
    [SPECIES_OLD_UNOWN_L] = sOldUnownLLevelUpLearnset,
    [SPECIES_OLD_UNOWN_M] = sOldUnownMLevelUpLearnset,
    [SPECIES_OLD_UNOWN_N] = sOldUnownNLevelUpLearnset,
    [SPECIES_OLD_UNOWN_O] = sOldUnownOLevelUpLearnset,
    [SPECIES_OLD_UNOWN_P] = sOldUnownPLevelUpLearnset,
    [SPECIES_OLD_UNOWN_Q] = sOldUnownQLevelUpLearnset,
    [SPECIES_OLD_UNOWN_R] = sOldUnownRLevelUpLearnset,
    [SPECIES_OLD_UNOWN_S] = sOldUnownSLevelUpLearnset,
    [SPECIES_OLD_UNOWN_T] = sOldUnownTLevelUpLearnset,
    [SPECIES_OLD_UNOWN_U] = sOldUnownULevelUpLearnset,
    [SPECIES_OLD_UNOWN_V] = sOldUnownVLevelUpLearnset,
    [SPECIES_OLD_UNOWN_W] = sOldUnownWLevelUpLearnset,
    [SPECIES_OLD_UNOWN_X] = sOldUnownXLevelUpLearnset,
    [SPECIES_OLD_UNOWN_Y] = sOldUnownYLevelUpLearnset,
    [SPECIES_OLD_UNOWN_Z] = sOldUnownZLevelUpLearnset,
